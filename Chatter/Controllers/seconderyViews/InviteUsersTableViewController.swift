...
class InviteUsersTableViewController: UITableViewController, UserTableViewCellDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.genrateCellWith(fUser: users![indexPath.row], indexPath: indexPath)
        cell.delegate = self
    ...
    @objc func doneButtonPressed() {
        ...
        if group != nil {
            ...
            let newGroupVC = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "newGroupView") as! NewGroupViewController
                  ...
                  newGroupVC.memberIds = newMemberIds
    ...
    func updateGroup(group: NSDictionary!) {
        ...
        var tempMembersToPush = [String]()
        if group != nil{
        tempMembersToPush = group[kMEMBERSTOPUSH] as! [String] + newMemberIds
        }else {
            tempMembersToPush =  newMemberIds
        }
    ...
    func goToGroupChat(membersToPush: [String], members: [String]) {
        ...
        chatVC.membarIds = members
        chatVC.membersToPush = membersToPush
        
        chatVC.chatRoonmId = group[kGROUPID] as! String
        chatVC.isGroup = true
